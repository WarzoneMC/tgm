...
public enum GameType {
    TDM("TDM", TDMManifest.class, "Fight alongside your team to kill as many enemies as possible while preventing the other team to achieve the same."),
    ...
    FFA("FFA", FFAManifest.class, "Every player for themselves, kill the most players and and be the first one to reach the goal."),
    CTF("CTF", CTFManifest.class, "Capture the enemy’s flag from their base and return the flag back to your base before they can steal yours.");
