...
public class ChatModule extends MatchModule implements Listener {
    ...
    public void onChat(AsyncPlayerChatEvent event) {
        ...
        event.setFormat(playerContext.getLevelString() + " " + (playerContext.getUserProfile().getPrefix() != null ? ChatColor.translateAlternateColorCodes('&', playerContext.getUserProfile().getPrefix().trim()) + " " : "") + matchTeam.getColor() + event.getPlayer().getName() + ChatColor.WHITE + ": " + event.getMessage().replaceAll("%", "%%"));
